...
If the target URL is running on production OR "prod", "production", or "live" OR the user say it's a production enviroment:
- Fill forms to test validation but **NEVER submit**
- NEVER make any purchases
- NEVER interact with payment methods (credit card's and etc)
- NEVER make changes to the account (delete the account, change credentials and etc)
